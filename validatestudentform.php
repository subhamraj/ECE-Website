...
$Aboutyourself = trim($_POST['Aboutyourself']);
...
$Feedback =trim($_POST['Feedback']);
	...
	include("imagevalidation.php");
		if($err == 0){
			$query = "INSERT INTO students (inrollno,program,Enrollmentyear,name,email,phoneno,address,interest,achievement,hobbies,feedback,gender) VALUES
			('$EnRollNo', '$Program', '$Enrollmentyear','$Name', '$Email', '$Phone','$Address','$Interest','$Achievement','$Hobbies','$Feedback','$Gender')";
			mysql_query($query);
