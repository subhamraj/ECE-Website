...
if($_SERVER["REQUEST_METHOD"] == "POST"){
	...
	include("validatealumniform.php");	
}
?>
<title>Alumni Registration From</title>
<head>
...
<body>
	...
	<br>
	<form class="form-horizontal" role="form" enctype="multipart/form-data" method = "POST" action  = "alumniform.php">
	 ...
	 <div class="form-group">
	  ...
	  <div class="form-group">
		...
		<div class="col-sm-8">
		  ...
		  value = "<?php echo $Enrollmentyear ?>" placeholder="Enter Enrollment year ">
		</div>
		<div class="col-sm-2">
		  <span class="pull-left alert-danger"><?php echo $EnrollmentyearErr  ?></span>
		</div>
	  </div>
	  ...
	  <div class="form-group">
	   ...
	   <div class="form-group">
		<label class="control-label col-sm-2" for="Image">IMAGE <font size = "4" color="red">*</font>:</label>
		<div class="col-sm-8">
	 ...
	 <div class="form-group">
		...
		<div class="col-sm-8">
		  <textarea class = "from-control" rows = "3" cols = "100" id="Job" name="Job" placeholder="Job" maxlength="200"><?php if(isset($Job)) { echo htmlentities ($Job);}?></textarea></textarea>
		</div>
	  </div>

	  <div class="form-group">
		<label class="control-label col-sm-2" for="HigherStudies">HIGHER STUDIES :</label>
		<div class="col-sm-8">
		  <textarea class = "from-control" rows = "3" cols = "100" id="HigherStudies" name="HigherStudies" placeholder="Higher Studies" maxlength="200"><?php if(isset($HigherStudies)) { 
         echo htmlentities ($HigherStudies);}?></textarea>
		</div>
	  </div>
	 ...
	 <div class="form-group">
	  ...
	  <div class="form-group">
		...
		<div class="col-sm-8">
		  <textarea class = "from-control" rows = "4" cols = "100" class="form-control" id = "Aboutyourself" 
		  name = "Aboutyourself" maxlength = "500" placeholder="Aboutyourself"><?php if(isset($Aboutyourself)) { echo htmlentities ($Aboutyourself);}?></textarea>
		</div>
	  </div>
