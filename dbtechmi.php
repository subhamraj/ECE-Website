<title>Dual B.Tech And M.Tech</title>
<?php 
...
<body style = "background-image: url(images/programs_background.jpg); background-size: 100%;">
				...
				<h2> Integrated M.Tech MI </h2>
				<p>
					The Syllabus of the Dual Degree M.Tech branch has been divided into numerous Semesters, each of which has numerous Subjects, which are as follows ...
				</p>
				...
				<div class = "semester">
					<div class = "sem_button">
						...
						<div>
							<table class = "sem_table">
								<tr>
									<td> Modeling and Analysis of Devices & Circuits </td>
								</tr>
								<tr>
				...
				<div class = "semester">
					<div class = "sem_button">
						...
						<div>
							<table class = "sem_table">
								<tr>
									<td> Hardware Design Methodology </td>
								</tr>
								<tr>
								...
								<tr>
									<td> Advance VLSI Devices & Technology </td>
								</tr>
							</table>
						</div>
					</div>
