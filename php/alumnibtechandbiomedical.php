<?php
$queryStudent = mysql_query("SELECT * FROM students WHERE program = 'Dual Degree B.Tech and M.Tech Biomedical'  AND enrollmentyear < '2012' ORDER BY inrollno"); 
?>
	<div id="DualDegreeBtechandBioMedical" class ="tab-pane fade">	
