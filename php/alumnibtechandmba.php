<?php
$queryStudent = mysql_query("SELECT * FROM students WHERE program = 'Dual Degree B.Tech and MBA' AND enrollmentyear < '2012' ORDER BY inrollno"); 
?>
	<div id="DualDegreeBtechandMba" class ="tab-pane fade">	
