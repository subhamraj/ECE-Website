<?php
$queryStudent = mysql_query("SELECT * FROM students WHERE program = 'Integrated M.Tech and Ph.D' AND enrollmentyear < '2012' ORDER BY inrollno"); 
?>
	<div id="IntegratedMtechandPhD" class ="tab-pane fade">	
