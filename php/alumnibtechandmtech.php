<?php
$queryStudent = mysql_query("SELECT * FROM students WHERE program = 'Dual Degree B.Tech and MI' AND enrollmentyear < '2012' ORDER BY inrollno"); 
?>
	<div id="DualDegreeBtechandMtech" class ="tab-pane fade">	
